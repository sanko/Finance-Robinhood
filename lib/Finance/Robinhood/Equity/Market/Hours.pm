...
sub _test_opens_at {
    t::Utility::stash('HOURS_OPEN') // skip_all();
    is( t::Utility::stash('HOURS_OPEN')->opens_at->to_string, '2019-03-15T13:30:00Z' );
    t::Utility::stash('HOURS_CLOSED') // skip_all();
...
sub _test_closes_at {
    t::Utility::stash('HOURS_OPEN') // skip_all();
    is( t::Utility::stash('HOURS_OPEN')->closes_at->to_string, '2019-03-15T20:00:00Z' );
    t::Utility::stash('HOURS_CLOSED') // skip_all();
...
sub extended_opens_at ($s) {
    $s->{extended_opens_at} ? Time::Moment->from_string( $s->{extended_opens_at} ) : ();
}

sub _test_extended_opens_at {
    t::Utility::stash('HOURS_OPEN') // skip_all();
    is( t::Utility::stash('HOURS_OPEN')->extended_opens_at->to_string, '2019-03-15T13:00:00Z' );
    t::Utility::stash('HOURS_CLOSED') // skip_all();
...
sub extended_closes_at ($s) {
    $s->{extended_closes_at} ? Time::Moment->from_string( $s->{extended_closes_at} ) : ();
}

sub _test_extended_closes_at {
    t::Utility::stash('HOURS_OPEN') // skip_all();
    is( t::Utility::stash('HOURS_OPEN')->extended_closes_at->to_string, '2019-03-15T22:00:00Z' );
    t::Utility::stash('HOURS_CLOSED') // skip_all();
...
sub _test_date {
    t::Utility::stash('HOURS_OPEN') // skip_all();
    is( t::Utility::stash('HOURS_OPEN')->date->to_string, '2019-03-15T00:00:00Z' );
    t::Utility::stash('HOURS_CLOSED') // skip_all();
    is( t::Utility::stash('HOURS_CLOSED')->date->to_string, '2019-03-16T00:00:00Z' );
}
...
sub _test_next_open_hours {
    t::Utility::stash('HOURS_OPEN') // skip_all();
    is( t::Utility::stash('HOURS_OPEN')->next_open_hours->date->to_string, '2019-03-18T00:00:00Z' );
    t::Utility::stash('HOURS_CLOSED') // skip_all();
    is(
